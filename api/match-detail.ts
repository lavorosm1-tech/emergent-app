/**
 * Involucro Vercel per /api/match-detail.
 *
 * L'implementazione NON e' qui: vive in netlify/functions/match-detail, la stessa
 ...
 */
import handler from "../netlify/functions/match-detail";
