/**
 * Involucro Vercel per /api/llm-settings.
 *
 * L'implementazione NON e' qui: vive in netlify/functions/llm-settings, la stessa
 ...
 */
import handler from "../netlify/functions/llm-settings";
