/**
 * Involucro Vercel per /api/results-fetch.
 *
 * L'implementazione NON e' qui: vive in netlify/functions/results-fetch, la stessa
 ...
 */
import handler from "../netlify/functions/results-fetch";
