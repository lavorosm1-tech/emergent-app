/**
 * Involucro Vercel per /api/selection-clear.
 *
 * L'implementazione NON e' qui: vive in netlify/functions/selection-clear, la stessa
 ...
 */
import handler from "../netlify/functions/selection-clear";
