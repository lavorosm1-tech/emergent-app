/**
 * Involucro Vercel per /api/stats-scores.
 *
 * L'implementazione NON e' qui: vive in netlify/functions/stats-scores, la stessa
 ...
 */
import handler from "../netlify/functions/stats-scores";
