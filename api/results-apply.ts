/**
 * Involucro Vercel per /api/results-apply.
 *
 * L'implementazione NON e' qui: vive in netlify/functions/results-apply, la stessa
 ...
 */
import handler from "../netlify/functions/results-apply";
