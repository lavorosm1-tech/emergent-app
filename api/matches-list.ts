/**
 * Involucro Vercel per /api/matches-list.
 *
 * L'implementazione NON e' qui: vive in netlify/functions/matches-list, la stessa
 ...
 */
import handler from "../netlify/functions/matches-list";
