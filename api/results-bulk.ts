/**
 * Involucro Vercel per /api/results-bulk.
 *
 * L'implementazione NON e' qui: vive in netlify/functions/results-bulk, la stessa
 ...
 */
import handler from "../netlify/functions/results-bulk";
