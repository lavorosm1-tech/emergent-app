/**
 * Involucro Vercel per /api/import-db.
 *
 * L'implementazione NON e' qui: vive in netlify/functions/import-db, la stessa
 ...
 */
import handler from "../netlify/functions/import-db";
