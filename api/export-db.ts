/**
 * Involucro Vercel per /api/export-db.
 *
 * L'implementazione NON e' qui: vive in netlify/functions/export-db, la stessa
 ...
 */
import handler from "../netlify/functions/export-db";
