/**
 * Involucro Vercel per /api/stats-reset.
 *
 * L'implementazione NON e' qui: vive in netlify/functions/stats-reset, la stessa
 ...
 */
import handler from "../netlify/functions/stats-reset";
