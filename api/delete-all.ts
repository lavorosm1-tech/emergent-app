/**
 * Involucro Vercel per /api/delete-all.
 *
 * L'implementazione NON e' qui: vive in netlify/functions/delete-all, la stessa
 ...
 */
import handler from "../netlify/functions/delete-all";
