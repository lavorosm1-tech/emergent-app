/**
 * Involucro Vercel per /api/save-verdict.
 *
 * L'implementazione NON e' qui: vive in netlify/functions/save-verdict, la stessa
 ...
 */
import handler from "../netlify/functions/save-verdict";
