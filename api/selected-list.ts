/**
 * Involucro Vercel per /api/selected-list.
 *
 * L'implementazione NON e' qui: vive in netlify/functions/selected-list, la stessa
 ...
 */
import handler from "../netlify/functions/selected-list";
