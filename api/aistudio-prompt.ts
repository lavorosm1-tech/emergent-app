/**
 * Involucro Vercel per /api/aistudio-prompt.
 *
 * L'implementazione NON e' qui: vive in netlify/functions/aistudio-prompt, la stessa
 ...
 */
import handler from "../netlify/functions/aistudio-prompt";
