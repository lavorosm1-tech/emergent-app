/**
 * Involucro Vercel per /api/selection-update.
 *
 * L'implementazione NON e' qui: vive in netlify/functions/selection-update, la stessa
 ...
 */
import handler from "../netlify/functions/selection-update";
