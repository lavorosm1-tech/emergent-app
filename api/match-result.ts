/**
 * Involucro Vercel per /api/match-result.
 *
 * L'implementazione NON e' qui: vive in netlify/functions/match-result, la stessa
 ...
 */
import handler from "../netlify/functions/match-result";
