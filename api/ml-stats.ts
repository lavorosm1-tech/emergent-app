/**
 * Involucro Vercel per /api/ml-stats.
 *
 * L'implementazione NON e' qui: vive in netlify/functions/ml-stats, la stessa
 ...
 */
import handler from "../netlify/functions/ml-stats";
