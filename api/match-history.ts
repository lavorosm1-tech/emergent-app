/**
 * Involucro Vercel per /api/match-history.
 *
 * L'implementazione NON e' qui: vive in netlify/functions/match-history, la stessa
 ...
 */
import handler from "../netlify/functions/match-history";
