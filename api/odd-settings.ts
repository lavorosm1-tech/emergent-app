/**
 * Involucro Vercel per /api/odd-settings.
 *
 * L'implementazione NON e' qui: vive in netlify/functions/odd-settings, la stessa
 ...
 */
import handler from "../netlify/functions/odd-settings";
