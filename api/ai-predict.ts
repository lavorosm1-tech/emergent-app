/**
 * Involucro Vercel per /api/ai-predict.
 *
 * L'implementazione NON e' qui: vive in netlify/functions/ai-predict, la stessa
 ...
 */
import handler from "../netlify/functions/ai-predict";
