/**
 * Involucro Vercel per /api/matches-days.
 *
 * L'implementazione NON e' qui: vive in netlify/functions/matches-days, la stessa
 ...
 */
import handler from "../netlify/functions/matches-days";
