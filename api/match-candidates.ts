/**
 * Involucro Vercel per /api/match-candidates.
 *
 * L'implementazione NON e' qui: vive in netlify/functions/match-candidates, la stessa
 ...
 */
import handler from "../netlify/functions/match-candidates";
