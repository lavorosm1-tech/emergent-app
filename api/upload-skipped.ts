/**
 * Involucro Vercel per /api/upload-skipped.
 *
 * L'implementazione NON e' qui: vive in netlify/functions/upload-skipped, la stessa
 ...
 */
import handler from "../netlify/functions/upload-skipped";
